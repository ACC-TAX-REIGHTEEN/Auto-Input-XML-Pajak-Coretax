...
FOLDER_DAPUR = "Dapur"
INPUT_FILES = ["AccEFaktur.xls", "AccCtxFaktur.xls"]
...
def get_default_filename():
    ...
    return f"XML-{now.day:02d}-{months[now.month]}-{year_short}"
...
def generate_filename_from_data(date_val):
    ...
    if dt:
        ...
        return f"XML-{dt.day:02d}-{months[dt.month]}-{year_short}"
    else:
        return None
